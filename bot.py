...
def is_owner(ctx):
	return ctx.message.author.id in (518731387591720961)
...
class Modmail(commands.Bot):
    ...
    def token(self):
        ...
        try:
            with open('config.json') as f:
                config = json.load(f)
                if config.get('TOKEN') == "NjE3NjA0NzI5NjY4NzYzNjQ4.XW6feA.AAKGccX5Z64NtYjLpN6jZVr6h28":
    ...
    def run_wizard():
        ...
        print('------------------------------------------')
        token = input('NjE3NjA0NzI5NjY4NzYzNjQ4.XW6feA.AAKGccX5Z64NtYjLpN6jZVr6h28:\n> ')
        print('------------------------------------------')
        data = {
                "TOKEN" : token,
            }
